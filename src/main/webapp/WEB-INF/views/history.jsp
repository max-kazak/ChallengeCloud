...
<head>
    ...
    <script type="text/javascript">
        ...
        function appendPosts() {
            if (max_num == 0) {
                $('#history-send').append('<h2>No history yet</h2><a href="home" class="btn btn-primary" role="button">Home</a>');
            }
            if (numShown < max_num) {
                ...
                $.ajax({
                    url: 'history-send.html?numToShow=' + numToShow.toString() + '&numShown=' + numShown.toString(),
                    success: function (data) {
                        $('#history-send').append(data);
                    }
                });
                numShown += numToShow;
            }
            ...
            <div class="col-md-2 col-md-offset-2">
                <div class="menu">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation" class="active"><a href="${history}">My history</a></li>
