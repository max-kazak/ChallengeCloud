...
insert into challenger.events values('2', "TwitterPostEvent", "com.codegroup.challengecloud.events.TwitterPostEvent"); /*Nipel-Crumple for event <---> achievement*/
...
insert into challenger.badges values("aislfu4odefsrgts", "Mister Twitter", "Congratulation! You've created 5 posts and got 'Mister Twitter' badge!", "dadsf87a823e98d2", "2", "{ \"twitterPosts\":5 }");
